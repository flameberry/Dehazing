...
from DehazingDataset import DehazingDataset, DatasetType
from train_orig import Preprocess
...
datasetPath = pathlib.Path('/Users/flameberry/Developer/Dehazing/dataset/SS594_Multispectral_Dehazing/Haze1k/Haze1k')
...
train_data_loader = tu_data.DataLoader(trainingDataset, batch_size=32, shuffle=True, num_workers=0)
val_data_loader = tu_data.DataLoader(validationDataset, batch_size=32, shuffle=True, num_workers=0)
